...
export class AppComponent implements OnInit, AfterViewInit {
  ...
  ngOnInit() {
    ...
    this.menuItems = [
      {label: 'Home', icon: 'fa fa-home', routerLink: ['/dashboard'], command: (event) => handleSelected(event)},
      {label: 'Test', icon: 'fa fa-calendar', routerLink: ['/test'], command: (event) => handleSelected(event)},
      {label: 'View', icon: 'fa fa-clock-o', routerLink: ['/view'], command: (event) => handleSelected(event)},
      {label: 'User', icon: 'fa fa-tasks', routerLink: ['/user'], command: (event) => handleSelected(event)},
